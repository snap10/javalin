...
public class Javalin {
    ...
    private Javalin addHandler(@NotNull HandlerType handlerType, @NotNull String path, @NotNull Handler handler, @NotNull Set<Role> roles, String documentation) {
        ...
        handlerMetaInfo.add(new HandlerMetaInfo(handlerType, prefixedPath, handler, roles, documentation));
        return this;
    }
    ...
    private Javalin addHandler(@NotNull HandlerType handlerType, @NotNull String path, @NotNull Handler handler, @NotNull Set<Role> roles) {
        return addHandler(handlerType, path, handler, roles, "No Documentation present");
    }
